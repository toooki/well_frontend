...
function SavetheList({ formData }) {
  ...
  return (
    <button onClick={handleSaveHealthData} className="save-button_checklist">저장</button>
    ...
    return (
      <div className="result-container">
        <div className="top-bar">
          <button className="main-menu-button-HC" onClick={() => { setShowResults(false); goToMenu(); }}>메인</button>
  ...
  if (exist == 1) {
    ...
    return (
      <div className="HealthChecklist_container">
        <div className="top-bar">
          <button type="button" className="HealthChecklist_main" onClick={() => goToMenu()}>메뉴</button>
          <button type="button" className="HealthChecklist_save" onClick={calculateScores}>제출</button>
          <SavetheList formData={formData} />
        </div>
        <div className="scroll-container">
          <h1>건강 체크프로그램</h1>
